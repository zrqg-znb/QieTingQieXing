"""
Django settings for personal_toolbox_backend project.
"""
...
ROOT_URLCONF = 'personal_toolbox_backend.urls'
...
WSGI_APPLICATION = 'personal_toolbox_backend.wsgi.application'
