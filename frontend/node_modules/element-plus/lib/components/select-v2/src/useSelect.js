...
const useSelect = (props, emit) => {
  ...
  const filterOptions = (query) => {
    ...
    const { filterMethod, remoteMethod } = vue.toRaw(props);
    const isFilterMethodValid = props.filterable && shared.isFunction(filterMethod);
    const isRemoteMethodValid = props.filterable && props.remote && shared.isFunction(remoteMethod);
